var parse5 = require('parse5'),
    ...
    Environment = require('./plugins/control_flow/environment');
...
//Parser handlers
//OPTIMIZATION: this handlers are quite performance-sensitive, so we don't use quite slow things like
